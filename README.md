...
![版本](https://img.shields.io/badge/版本-2.6.0-blue)
...
### 📖 课程大纲（V2.5 新增 | V2.6 增强）

课程→章→节→知识点四级树形结构，形成教与学的主线：

- **AI 智能生成**：上传教材文本或文档，AI 自动提取课程结构并保存
- **资源绑定**：为每个知识点绑定 HTML 课件、试题、考试、讨论、任务等 7 类资源
- **学习进度追踪**：学生逐知识点学习、标记完成，实时显示课程进度条
- **教师总览**：查看全班学生的知识点完成进度矩阵
- **节点拖动排序**：同级拖拽重排 + 跨层级拖动（章节移入子章节、知识点跨章移动）

> **V2.6 优化**：AI 导入全面升级 — 统一 Prompt 模板，修正知识点错分章节 bug，AI 后处理自动修正不合格知识点，根据节内容智能生成知识点（每节至少 1~2 个），修复知识点名与节名重复问题。默认使用文件上传方式导入，操作更简洁。
