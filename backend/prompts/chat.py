...
**⚠️ 安全约束**：SVG 配图中**严禁**出现题目答案、解析说明、选项正误标记或任何会泄露正确选项的文字内容；只能展示中性的原理、结构或技术图示。
...
- 如果是电路图，使用标准电路元件符号
**⚠️ 安全约束（极其重要！）**：SVG 中禁止出现题目的答案、解析说明、选项正误判断或任何泄露正确答案的文字和符号。只能绘制中性、客观的技术原理图示，不得标注正确/错误选项。
...
**重要安全规则**：图片中禁止出现任何与题目答案、选项正误判断、解析说明相关的文字或符号。只能展示中性、客观的视觉内容，不得泄露正确答案或解题线索。
"""
